...
public class StringQuests {
    ...
    public static int countMinimumBracketReversals(String expression) {
        ...
        // return  ((Double) (Math.ceil(openingBraceCount / 2.0) + Math.ceil(closingBraceCount / 2.0))).intValue();
    ...
    public static char getKthCharacterOfEncodedString(String encodedString, int k) {
        // Repetitions of substrings are represented as substring followed by count of substrings.
        // Ex: if encoded string is “ab2cd2” and k=4 , decoded string is “ababcdcd” and 4th character is ‘b’.
        ...
        while(index < encodedString.length()) {
            ...
            while( index < length
                    && !Character.isDigit(encodedString.charAt(index))) {
