...
public class Puzzles {
    ...
    public static List<Board> getAllSolutionsForNQueens(int[][] board) {
        // Note: Any of the nQueens solution variant could be used here (backtracking, branch & bound, etc.)
        ...
        generateAllSolutionsForNQueens(board, rowCount, columnCount, 0, solutions);
    ...
    private static void generateAllSolutionsForNQueens(int[][] board, int rowCount, int columnCount,
                                                       int column, List<Board> solutions) {
        ...
        for (int i = 0; i < rowCount; i++) {
            if (isSafeForQueenWithBacktracking(board, i, column)) {
                board[i][column] = 1;
                generateAllSolutionsForNQueens(board, rowCount, columnCount, column + 1, solutions);
    ...
    public static boolean knightsTour(int[][] board) {
        ...
        // Note: This algorithm will work with any starting co-ordinate, not necessarily 0.
        int moveNumber = 0;
